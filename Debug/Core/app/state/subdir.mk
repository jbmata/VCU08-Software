...
C_SRCS += \
../Core/app/state/inverter_sm.c 

OBJS += \
./Core/app/state/inverter_sm.o 

C_DEPS += \
./Core/app/state/inverter_sm.d 


# Each subdirectory must supply rules for building sources it contributes
Core/app/state/%.o Core/app/state/%.su Core/app/state/%.cyclo: ../Core/app/state/%.c Core/app/state/subdir.mk
...
clean: clean-Core-2f-app-2f-state

clean-Core-2f-app-2f-state:
	-$(RM) ./Core/app/state/inverter_sm.cyclo ./Core/app/state/inverter_sm.d ./Core/app/state/inverter_sm.o ./Core/app/state/inverter_sm.su

.PHONY: clean-Core-2f-app-2f-state
